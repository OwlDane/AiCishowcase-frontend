        ...
        const content = isNodeItem ? (
          ...
          <img
            className={cx(
              ...
              'motion-reduce:transition-none',
              grayscaleOnLoop && 'grayscale opacity-60 group-hover/item:grayscale-0 group-hover/item:opacity-100 transition-all duration-300',
              scaleOnHover &&
                'transition-transform duration-300 ease-in-out group-hover/item:scale-120'
            )}
            src={(item as any).src}
        ...
        return (
          <li
            className={cx(
              'flex-none text-(length:--logoloop-logoHeight) leading-none',
              isVertical ? 'mb-(--logoloop-gap)' : 'mr-(--logoloop-gap)',
              (scaleOnHover || grayscaleOnLoop) && 'overflow-visible group/item'
            )}
            key={key}
            role="listitem"
          >
