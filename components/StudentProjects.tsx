    ...
    return (
        <section className="py-24 px-6 bg-primary text-white">
            <div className="max-w-7xl mx-auto text-center">
                <h2 className="text-4xl font-bold mb-6">Students Project</h2>
                <p className="text-white/70 max-w-3xl mx-auto mb-16 px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {projects.map((project, index) => (
                        <div key={index} className="bg-white rounded-4xl p-6 shadow-xl transition-transform hover:scale-105">
